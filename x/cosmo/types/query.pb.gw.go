...
var (
	pattern_Query_Vote_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"BiKunTin", "cosmo", "vote", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_VoteAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"BiKunTin", "cosmo", "vote"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Poll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"BiKunTin", "cosmo", "poll", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PollAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"BiKunTin", "cosmo", "poll"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Comment_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"BiKunTin", "cosmo", "comment", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CommentAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"BiKunTin", "cosmo", "comment"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Post_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"BiKunTin", "cosmo", "post", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_PostAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"BiKunTin", "cosmo", "post"}, "", runtime.AssumeColonVerbOpt(true)))
)
