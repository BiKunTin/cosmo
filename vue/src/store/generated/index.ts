...
import BiKunTinCosmoBiKunTinCosmoCosmo from './BiKunTin/cosmo/BiKunTin.cosmo.cosmo'
...
export default { 
  ...
  BiKunTinCosmoBiKunTinCosmoCosmo: load(BiKunTinCosmoBiKunTinCosmoCosmo, 'BiKunTin.cosmo.cosmo'),
